...
import yo from "../assets/img/aboutme.jpg";
  ...
  return (
    <React.Fragment>
      <section className="about-me relative mt-16" id="about-me" ref={ref}>
        ...
        <div className="flex flex-row justify-center gap-16 items-center pl-32 pr-32 mb-16 max-lg:flex-col max-lg:p-16">
          {/* Imagen */}
          <article className="flex justify-center items-center w-1/2 max-lg:w-full">
            <img
              src={yo}
              alt="About Me"
          ...
          >
            {paragraphs.map((paragraph, index) => (
              <SwiperSlide
                className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-24 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] hover:border-[--verdementa] duration-500 transition-all text-left max-lg:p-10 cursor-grab"
                key={index}
              >
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  <div className="flex flex-col gap-4 items-center justify-between -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
                    <p className="text-white">
                      <span className="text-[--verdementa]">&lt;</span>h3
                      <span className="text-[--verdementa]">/&gt;</span>
                    </p>
            ...
            <div
              className="autoplay-progress absolute right-0 bottom-0 z-10 flex items-center justify-center font-bold text-[--verdementa] text-4xl w-24 h-24 max-lg:w-16 max-lg:h-16 max-lg:text-3xl"
              slot="container-end"
            >
